...
use Bundle\AdminBundle\Entity\Album;
use Bundle\AdminBundle\Form\AlbumType;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Album')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('albums_show', array('id' => $entity->getId())));
        }

        return $this->render('AdminBundle:Album:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Album $entity)
    {
        $form = $this->createForm(new AlbumType(), $entity, array(
            'action' => $this->generateUrl('albums_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Album')->find($id);
        ...
        return $this->render('AdminBundle:Album:show.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new AlbumType(), $entity, array(
            'action' => $this->generateUrl('albums_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('albums_delete', array('id' => $id)))
            ->setMethod('DELETE')
